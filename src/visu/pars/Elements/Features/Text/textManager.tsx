...
{       
    ...
    let fontWeight = Number(section.getElementsByTagName("font-weight")[0].textContent);
    let isItalic = util.stringToBoolean(section.getElementsByTagName("font-italic")[0].textContent);
    let hasStrikeOut = util.stringToBoolean(section.getElementsByTagName("font-strike-out")[0].textContent);
    let hasUnderline = util.stringToBoolean(section.getElementsByTagName("font-underline")[0].textContent);
    let charSet = Number(section.getElementsByTagName("font-char-set")[0].textContent);
    let fontColor = util.rgbToHexString(section.getElementsByTagName("font-color")[0].textContent);
    // The static text flags
    
    let textAlignHorz = section.getElementsByTagName("text-align-horz")[0].textContent;
    let textAlignVert = section.getElementsByTagName("text-align-vert")[0].textContent;
    let text = section.getElementsByTagName("text-format")[0].textContent;
