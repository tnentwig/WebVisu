...
export class VisuBasicElement {
    protected has_inside_color : number;
    ...
    constructor(has_inside_color : number, fill_color : number, fill_color_alarm : number, has_frame_color : boolean, frame_color : number, frame_color_alarm : number, line_width : number, elem_id : number, rect : Array<number>, center : Array<number>, hidden_input : boolean, enable_text_input : boolean) {
